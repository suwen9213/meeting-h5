...
<body>
    ...
    <script>
        ...
        const scheduleData = {
            ...
            rows: [
                ['5.30', '08:30-10:00', '铸牢中华民族共同体意识', '达宝次仁（西藏党委党校）', '--', '学术报告厅（渭城校区）'],
                ['5.30', '10:20-11:50', '青年学生干部综合素养提升与发展规划', '马天祥', '--', '学术报告厅（渭城校区）'],
                ['5.30', '14:50-16:20', '依法治理藏传佛教的实践与启示', '达宝次仁（西藏党委党校）', '--', '学术报告厅（渭城校区）'],
                ['5.30', '16:40-18:10', '西藏和平解放75周年', '李荟芹', '--', '学术报告厅（渭城校区）'],
                ['6.6', '08:30-10:00', '青年骨干社会调研与田野实践', '更登磋', '--', '五一新村学术报告厅'],
                ['6.6', '10:20-11:50', '笔杆子与会务通：学生干部办文办会实战指南', '唐玮', '--', '五一新村学术报告厅'],
                ['6.6', '15:00-16:00', '交流研讨（校园管理）', '--', '--', 'A教'],
                ['6.10', '16:30-18:00', '大学生廉洁教育', '李书勇', '闹布', 'T201（渭城校区）'],
                ['6.11', '19:30-21:00', '传唱红色旋律，感悟百年征程', '王唯宇', '罗爽', '学术报告厅（五一新村）'],
                ['6.12', '13:00-18:00', '安全（消防）体验教育课程', '保卫部', '闹布', '西咸消防']  
            ]
        };
